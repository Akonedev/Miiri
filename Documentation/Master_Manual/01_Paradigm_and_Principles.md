...
L'approche Miiri-256 passe au **Système 2 (Pensée Lente, Délibérative et Vérifiée)**.
...
L'Miiri-256 modélise ce Mentalese sous la forme d'un vecteur structuré de dimension 256 ($d=256$).
...
L'Miiri-256 utilise la **Récurrence Latente (LSRA)** : un bloc neuronal restreint qui boucle sur son propre état caché. 
